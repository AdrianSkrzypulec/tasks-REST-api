...
class TrelloFacadeTest {
    ...
    void shouldFetchTrelloBoards() {
        ...
        // Then
        assertThat(trelloBoardDtos.size(), equalTo(1));
        assertThat(trelloBoardDtos, notNullValue());

        trelloBoardDtos.forEach(trelloBoardDto -> {

            assertThat(trelloBoardDto.getId(), equalTo("1"));
            assertThat(trelloBoardDto.getName(), equalTo("test"));

            trelloBoardDto.getLists().forEach(trelloListDto -> {
                assertThat(trelloListDto.getId(), equalTo("1"));
                assertThat(trelloListDto.getName(), equalTo("test_list"));
                assertThat(trelloListDto.isClosed(), equalTo(false));
            });
        });
